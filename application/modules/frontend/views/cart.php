                         ...
                         <?php foreach ($this->cart->contents() as $item) { ?>
                          ...
                          <tr>
                              ...
                              <td class="text-left" data-th="Quantity">
                                  ...
                                  <div class="product_count">
                                    <?php
                                      $id_produk = $item['id'];
                                      $connect = mysqli_connect("localhost","root","","db_toko1");
                                       $query2 = mysqli_query($connect, "SELECT jumlah from produk where id_produk='$id_produk'");
                                       $data2 = mysqli_fetch_array($query2);
                                       $qty_db = $data2['jumlah'];
                                       ?>
                                       <input type="number" min='0' max='<?php echo $qty_db?>' name="cart[<?php echo $item['id'];?>][qty]" value="<?= $item['qty'];?>">
                           ...
                           <td>
                            <a  href="<?= base_url('frontend/Cart/delete1/'.$item['rowid']);?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus produk ini dari keranjang ?')"> <i class="fas fa-trash-alt"></i> Hapus </a>
                          ...
                          <tr class="bottom_button">
                              ...
                              <td colspan="6">
                                  ...
                                  <button class="btn btn-success" id="baruicart" href="<?= base_url('frontend/Cart/updatee');?>"><i class='fas fa-sync'></i> Perbarui Pesanan</button>

                                  </form>

                                  <button class="btn btn-danger" id="deletecart" ><i class="fas fa-folder-minus"></i> Kosongkan Pesanan</button>
                          ...
                          <tr class="out_button_area">
                              ...
                              <td>
                                  ...
                                  <div class="checkout_btn_inner d-flex align-items-center">
                                      ...
                                      <button class="primary-btn ml-2" id="cekout" value="<?= $this->cart->total();?>" ><i class="fab fa-telegram-plane"></i> Pesan</button>
